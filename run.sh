...
# FullFace Gaze Estimation - 実行スクリプト
# 前処理 -> 学習 -> 評価を順次実行

set -e  # エラーが発生したら停止

echo "=========================================="
echo "FullFace Gaze Estimation Pipeline"
echo "=========================================="

# 設定
CONFIG_FILE="configs/ff_default.yaml"
RAW_DATA_DIR="raw_data/FullFace"
PROCESSED_DATA_DIR="data/images"
